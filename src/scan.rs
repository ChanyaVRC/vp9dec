...
#[rustfmt::skip]
pub const COL_SCAN_4X4: [u16; 16] = [
    0, 4, 8, 1, 12, 5, 9, 2, 13, 6, 10, 3, 7, 14, 11, 15,
];

#[rustfmt::skip]
pub const ROW_SCAN_4X4: [u16; 16] = [
...
#[rustfmt::skip]
pub const COL_SCAN_16X16: [u16; 256] = [
...
#[rustfmt::skip]
pub const ROW_SCAN_16X16: [u16; 256] = [
