...
- **No SIMD for the 10/12-bit path, reference-scaled inter prediction, or vertical loop-filter
  edges** (nor aarch64 NEON). The scalar path there is correct and bit-exact; this is a
